...
Source0  : https://files.pythonhosted.org/packages/3d/d6/1f90c457ee032c933896938934256f76c50d0b9c8a4fdcce30791e23f2ac/google-api-python-client-2.61.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.61.0
cd %{_builddir}/google-api-python-client-2.61.0
pushd ..
cp -a google-api-python-client-2.61.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663176121
