...
Source0  : https://files.pythonhosted.org/packages/73/d0/4a82e36c514437fa977d9b24f15328cd4505a0d92fcab9a18c81210b0f72/google_api_python_client-2.162.0.tar.gz
...
%prep
%setup -q -n google_api_python_client-2.162.0
cd %{_builddir}/google_api_python_client-2.162.0
pushd ..
cp -a google_api_python_client-2.162.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740589436
