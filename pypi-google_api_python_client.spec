...
Source0  : https://files.pythonhosted.org/packages/57/2e/cbed6b49ff1df5e4a332e03734eaa47d300a94d9975cf97485ba4785117b/google-api-python-client-2.46.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.46.0
cd %{_builddir}/google-api-python-client-2.46.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1651014927
...
cp %{_builddir}/google-api-python-client-2.46.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-google_api_python_client/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
