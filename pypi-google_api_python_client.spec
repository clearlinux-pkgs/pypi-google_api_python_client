...
Source0  : https://files.pythonhosted.org/packages/7a/c5/898280fd3b9ccdb4ec23263846ec0c998cb0c09826a91eb2a8eee007bc98/google-api-python-client-2.107.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.107.0
cd %{_builddir}/google-api-python-client-2.107.0
pushd ..
cp -a google-api-python-client-2.107.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699387013
