...
Source0  : https://files.pythonhosted.org/packages/9d/61/ba0eb2aa5661bd5c7400e75233231e1b1344f8619e970f30b957be41b24c/google-api-python-client-2.34.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.34.0
cd %{_builddir}/google-api-python-client-2.34.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642004923
...
cp %{_builddir}/google-api-python-client-2.34.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-google_api_python_client/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
