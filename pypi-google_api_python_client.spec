...
Source0  : https://files.pythonhosted.org/packages/0a/50/c8d2d3c4e65e081c4c07b15e4fe35671676c5ecdb3674a167229e83ce49a/google_api_python_client-2.161.0.tar.gz
...
%prep
%setup -q -n google_api_python_client-2.161.0
cd %{_builddir}/google_api_python_client-2.161.0
pushd ..
cp -a google_api_python_client-2.161.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739471673
