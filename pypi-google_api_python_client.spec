...
Source0  : https://files.pythonhosted.org/packages/02/69/c0cec6be5878d4de161f64096edb3d4a2d1a838f036b8425ea8358d0dfb3/google_api_python_client-2.172.0.tar.gz
...
%prep
%setup -q -n google_api_python_client-2.172.0
cd %{_builddir}/google_api_python_client-2.172.0
pushd ..
cp -a google_api_python_client-2.172.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749680520
