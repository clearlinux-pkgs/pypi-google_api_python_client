...
Source0  : https://files.pythonhosted.org/packages/b8/ca/4fcfeb70d90f70f9784e10b79f6db41463278e5e4acef00606b8ef4e9bbb/google-api-python-client-2.66.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.66.0
cd %{_builddir}/google-api-python-client-2.66.0
pushd ..
cp -a google-api-python-client-2.66.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668646805
