...
Source0  : https://files.pythonhosted.org/packages/04/0e/5f8e84ec422e5037eb38c6ee3cc3b8c5a4f74ab5b7b099ebb7d00762f73d/google-api-python-client-2.111.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.111.0
cd %{_builddir}/google-api-python-client-2.111.0
pushd ..
cp -a google-api-python-client-2.111.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702497202
