...
Source0  : https://files.pythonhosted.org/packages/8f/7e/7c6e43e54f611f0f97f1678ea567fe06fecd545bd574db05e204e5b136fe/google_api_python_client-2.173.0.tar.gz
...
%prep
%setup -q -n google_api_python_client-2.173.0
cd %{_builddir}/google_api_python_client-2.173.0
pushd ..
cp -a google_api_python_client-2.173.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750433687
