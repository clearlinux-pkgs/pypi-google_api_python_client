...
Source0  : https://files.pythonhosted.org/packages/ae/c2/274e6088d75ba93784442ed82f0bdf578571123f979b4608b61c72d06872/google-api-python-client-2.72.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.72.0
cd %{_builddir}/google-api-python-client-2.72.0
pushd ..
cp -a google-api-python-client-2.72.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673386199
