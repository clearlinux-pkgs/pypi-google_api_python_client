...
Source0  : https://files.pythonhosted.org/packages/0d/a5/ecbcb0e6340c960f6077a92c806603caaeefc2b827a53a3c1d994b126e76/google-api-python-client-2.63.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.63.0
cd %{_builddir}/google-api-python-client-2.63.0
pushd ..
cp -a google-api-python-client-2.63.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664312080
