...
Source0  : https://files.pythonhosted.org/packages/0f/36/b82e5cc246ce698953c42003284e2779688daa7448099bc0a0027e63b52a/google-api-python-client-2.65.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.65.0
cd %{_builddir}/google-api-python-client-2.65.0
pushd ..
cp -a google-api-python-client-2.65.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666134434
