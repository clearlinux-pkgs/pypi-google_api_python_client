...
Source0  : https://files.pythonhosted.org/packages/b8/fa/861931cf33f3d91d0d17001af3249cfc2af2b5a1b8472604420c025f3339/google_api_python_client-2.154.0.tar.gz
...
%prep
%setup -q -n google_api_python_client-2.154.0
cd %{_builddir}/google_api_python_client-2.154.0
pushd ..
cp -a google_api_python_client-2.154.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732138936
