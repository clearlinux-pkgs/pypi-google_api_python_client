...
Source0  : https://files.pythonhosted.org/packages/32/ba/510bc5d8e786acff203f2bc77749a4d464592ddc13cfdb75a526ba6294cd/google_api_python_client-2.138.0.tar.gz
...
%prep
%setup -q -n google_api_python_client-2.138.0
cd %{_builddir}/google_api_python_client-2.138.0
pushd ..
cp -a google_api_python_client-2.138.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722006749
