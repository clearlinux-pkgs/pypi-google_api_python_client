...
Source0  : https://files.pythonhosted.org/packages/c4/c9/eac7b4e843039f0a54a563c2328d43de6f02e426a11b6a7e378996f667db/google_api_python_client-2.166.0.tar.gz
...
%prep
%setup -q -n google_api_python_client-2.166.0
cd %{_builddir}/google_api_python_client-2.166.0
pushd ..
cp -a google_api_python_client-2.166.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743084707
