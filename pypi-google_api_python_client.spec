...
Source0  : https://files.pythonhosted.org/packages/5e/d1/f3a95edeb05f21b83f2adb2a04181b0bf667c6d595a5cf6dea474e220d2b/google-api-python-client-2.134.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.134.0
cd %{_builddir}/google-api-python-client-2.134.0
pushd ..
cp -a google-api-python-client-2.134.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718919760
