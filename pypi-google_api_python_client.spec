...
Source0  : https://files.pythonhosted.org/packages/d5/b5/46e6a866407e1d620d6722e7f5e076c3908801b6bc122e0908ea92b9d78f/google_api_python_client-2.165.0.tar.gz
...
%prep
%setup -q -n google_api_python_client-2.165.0
cd %{_builddir}/google_api_python_client-2.165.0
pushd ..
cp -a google_api_python_client-2.165.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742431409
