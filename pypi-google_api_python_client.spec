...
Source0  : https://files.pythonhosted.org/packages/b2/41/33d135430af3b5add22bf77635b6f6e20f218db61aa8566fdd932110c002/google-api-python-client-2.45.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.45.0
cd %{_builddir}/google-api-python-client-2.45.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650384180
...
cp %{_builddir}/google-api-python-client-2.45.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-google_api_python_client/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
