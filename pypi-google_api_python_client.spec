...
Source0  : https://files.pythonhosted.org/packages/d9/a1/0bd557922bd9cf8b544547f3e91346fda767c11831250cf90f1d7ec920d5/google_api_python_client-2.139.0.tar.gz
...
%prep
%setup -q -n google_api_python_client-2.139.0
cd %{_builddir}/google_api_python_client-2.139.0
pushd ..
cp -a google_api_python_client-2.139.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722441204
