...
Source0  : https://files.pythonhosted.org/packages/4b/0f/11bee0ff9025483fc30634a775416170b95421a84db70b4482ce8449cd77/google-api-python-client-2.79.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.79.0
cd %{_builddir}/google-api-python-client-2.79.0
pushd ..
cp -a google-api-python-client-2.79.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677016194
