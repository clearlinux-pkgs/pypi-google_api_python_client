...
Source0  : https://files.pythonhosted.org/packages/ab/16/c6b8e041f2d9f6aebc6cbdd6451e029d3c10ff5180a7fc70823279aa6419/google-api-python-client-2.75.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.75.0
cd %{_builddir}/google-api-python-client-2.75.0
pushd ..
cp -a google-api-python-client-2.75.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675207893
