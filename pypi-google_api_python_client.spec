...
Version  : 2.48.0
Release  : 87
URL      : https://files.pythonhosted.org/packages/32/ce/a3ddd0d18ab4364482e42e166ae3cd61307499a936ad384663438d10bf83/google-api-python-client-2.48.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/32/ce/a3ddd0d18ab4364482e42e166ae3cd61307499a936ad384663438d10bf83/google-api-python-client-2.48.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.48.0
cd %{_builddir}/google-api-python-client-2.48.0
pushd ..
cp -a google-api-python-client-2.48.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653333198
...
cp %{_builddir}/google-api-python-client-2.48.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-google_api_python_client/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
