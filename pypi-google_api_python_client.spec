...
Source0  : https://files.pythonhosted.org/packages/a2/e5/44cac8e47820a9a8b4231305119becc15ec94568f55954a759276b74fb8f/google-api-python-client-2.52.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.52.0
cd %{_builddir}/google-api-python-client-2.52.0
pushd ..
cp -a google-api-python-client-2.52.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656513206
...
cp %{_builddir}/google-api-python-client-2.52.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-google_api_python_client/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
