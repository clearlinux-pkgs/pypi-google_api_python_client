...
Source0  : https://files.pythonhosted.org/packages/82/9d/22aac91db2ae696423ef5d5331781b7119e54cad0807da81ee8a6ba6129e/google-api-python-client-2.88.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.88.0
cd %{_builddir}/google-api-python-client-2.88.0
pushd ..
cp -a google-api-python-client-2.88.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1685460641
