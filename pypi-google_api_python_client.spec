...
Source0  : https://files.pythonhosted.org/packages/5a/9f/12b58cca5a93d63fd6a7abed570423bdf2db4349eb9361ac5214d42ed7d6/google_api_python_client-2.159.0.tar.gz
...
%prep
%setup -q -n google_api_python_client-2.159.0
cd %{_builddir}/google_api_python_client-2.159.0
pushd ..
cp -a google_api_python_client-2.159.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736860596
