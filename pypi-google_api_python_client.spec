...
Source0  : https://files.pythonhosted.org/packages/7e/36/82d6ee50e68c82b27512d7e813fc9705eab4abf89e0efe1e5316e636b50c/google-api-python-client-2.69.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.69.0
cd %{_builddir}/google-api-python-client-2.69.0
pushd ..
cp -a google-api-python-client-2.69.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670882190
