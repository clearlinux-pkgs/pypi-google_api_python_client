...
Source0  : https://files.pythonhosted.org/packages/fc/ff/b86fd823d0ffe6a02d3de9820b096ea3f6e978e87bda190e0d02a87bc18a/google-api-python-client-2.36.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.36.0
cd %{_builddir}/google-api-python-client-2.36.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642606921
...
cp %{_builddir}/google-api-python-client-2.36.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-google_api_python_client/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
