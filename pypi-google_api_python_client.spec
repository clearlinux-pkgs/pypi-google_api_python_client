...
Source0  : https://files.pythonhosted.org/packages/2e/82/dff26df93999545192d8511d84e3d692b9a3f27df0e3ef47eb9518c98dfa/google-api-python-client-2.44.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.44.0
cd %{_builddir}/google-api-python-client-2.44.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649806685
...
cp %{_builddir}/google-api-python-client-2.44.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-google_api_python_client/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
