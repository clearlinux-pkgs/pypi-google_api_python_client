...
Source0  : https://files.pythonhosted.org/packages/2a/d1/3a23d5b4b967f08aebbfe76e2651416869a765791fbc42f4b78774f48137/google_api_python_client-2.167.0.tar.gz
...
%prep
%setup -q -n google_api_python_client-2.167.0
cd %{_builddir}/google_api_python_client-2.167.0
pushd ..
cp -a google_api_python_client-2.167.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744638387
