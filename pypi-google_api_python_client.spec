...
Source0  : https://files.pythonhosted.org/packages/a7/ff/a8bc30fdbc62ce1b504a878c586c72c9d3308508fca0aa7a7d694ec080da/google-api-python-client-2.64.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.64.0
cd %{_builddir}/google-api-python-client-2.64.0
pushd ..
cp -a google-api-python-client-2.64.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664982464
