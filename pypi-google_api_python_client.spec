...
Source0  : https://files.pythonhosted.org/packages/75/54/f8a7dfb11fb40aa020df48068e82b23a16f73502c9f5d513c01e7941db0a/google-api-python-client-2.49.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.49.0
cd %{_builddir}/google-api-python-client-2.49.0
pushd ..
cp -a google-api-python-client-2.49.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653582313
...
cp %{_builddir}/google-api-python-client-2.49.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-google_api_python_client/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
