...
Source0  : https://files.pythonhosted.org/packages/d0/e8/9a71d196a6ab2619d6af19003bb7d27f5d6fcab3233c65019a11d04f8cf7/google-api-python-client-2.81.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.81.0
cd %{_builddir}/google-api-python-client-2.81.0
pushd ..
cp -a google-api-python-client-2.81.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678749187
