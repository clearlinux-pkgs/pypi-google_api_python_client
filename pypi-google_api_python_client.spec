...
Source0  : https://files.pythonhosted.org/packages/ae/82/ca6b5208faa63f791c4e4e132126849cc1c3488d2db11fd92764fd6cd555/google-api-python-client-2.115.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.115.0
cd %{_builddir}/google-api-python-client-2.115.0
pushd ..
cp -a google-api-python-client-2.115.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706045993
