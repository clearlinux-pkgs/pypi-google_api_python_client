...
Source0  : https://files.pythonhosted.org/packages/a8/fe/71091bf1a9f2fa50c06a6caa94b579da7d354d83ac01a4c34b139808d332/google-api-python-client-2.70.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.70.0
cd %{_builddir}/google-api-python-client-2.70.0
pushd ..
cp -a google-api-python-client-2.70.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672275263
