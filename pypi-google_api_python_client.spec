...
Source0  : https://files.pythonhosted.org/packages/db/86/1bd09aea2664a46bc65713cb7876381ec8949a4b1e71be97dfc359c79781/google_api_python_client-2.170.0.tar.gz
...
%prep
%setup -q -n google_api_python_client-2.170.0
cd %{_builddir}/google_api_python_client-2.170.0
pushd ..
cp -a google_api_python_client-2.170.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748010176
