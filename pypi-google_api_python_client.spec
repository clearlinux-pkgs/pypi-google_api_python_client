...
Source0  : https://files.pythonhosted.org/packages/bc/de/8b6eb80aa71052f5ae6126822413f40fb8c0038cca8717df91dc4d267863/google-api-python-client-2.68.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.68.0
cd %{_builddir}/google-api-python-client-2.68.0
pushd ..
cp -a google-api-python-client-2.68.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669934710
