...
Source0  : https://files.pythonhosted.org/packages/6f/6b/4f814f372a3a3ecee569c72a639fa010ea412d4e9b4e7edd5f1dac726f85/google-api-python-client-2.131.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.131.0
cd %{_builddir}/google-api-python-client-2.131.0
pushd ..
cp -a google-api-python-client-2.131.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717010845
