...
Source0  : https://files.pythonhosted.org/packages/b7/c1/2418c084eac8126fa3b5f52eb70de04564023040dea23a9e9cb856327785/google-api-python-client-2.122.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.122.0
cd %{_builddir}/google-api-python-client-2.122.0
pushd ..
cp -a google-api-python-client-2.122.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710539740
