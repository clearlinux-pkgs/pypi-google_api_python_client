...
Source0  : https://files.pythonhosted.org/packages/b3/d7/ed1626cb92ffe68a17c5e5b3f0331e20f3ff6ef24deedffd4a70db49e0b0/google_api_python_client-2.158.0.tar.gz
...
%prep
%setup -q -n google_api_python_client-2.158.0
cd %{_builddir}/google_api_python_client-2.158.0
pushd ..
cp -a google_api_python_client-2.158.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736455799
