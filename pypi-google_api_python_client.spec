...
Version  : 2.51.0
Release  : 92
URL      : https://files.pythonhosted.org/packages/66/d3/1c62a20ecd5c7915ce19b31e71fdb1d02aee26e6c90b6ee0195f0d4cdcd8/google-api-python-client-2.51.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/66/d3/1c62a20ecd5c7915ce19b31e71fdb1d02aee26e6c90b6ee0195f0d4cdcd8/google-api-python-client-2.51.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.51.0
cd %{_builddir}/google-api-python-client-2.51.0
pushd ..
cp -a google-api-python-client-2.51.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656403042
...
cp %{_builddir}/google-api-python-client-2.51.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-google_api_python_client/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
