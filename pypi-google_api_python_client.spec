...
Source0  : https://files.pythonhosted.org/packages/9e/bd/8c3d136a95bdb1311cd5808e0d64dfdb457bfa421cc254d0cb07c3d522eb/google-api-python-client-2.77.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.77.0
cd %{_builddir}/google-api-python-client-2.77.0
pushd ..
cp -a google-api-python-client-2.77.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675884709
