...
Version  : 2.53.0
Release  : 94
URL      : https://files.pythonhosted.org/packages/e6/0b/2bf87693e2b184fa8be8abcb2c17637e97d441b8c4d8ea352f46810326dc/google-api-python-client-2.53.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/e6/0b/2bf87693e2b184fa8be8abcb2c17637e97d441b8c4d8ea352f46810326dc/google-api-python-client-2.53.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.53.0
cd %{_builddir}/google-api-python-client-2.53.0
pushd ..
cp -a google-api-python-client-2.53.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657894461
...
cp %{_builddir}/google-api-python-client-2.53.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-google_api_python_client/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
