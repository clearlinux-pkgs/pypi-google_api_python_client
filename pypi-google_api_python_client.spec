...
Source0  : https://files.pythonhosted.org/packages/35/fb/bc60f2123690c247a6a8048773a63bfc4c95821287d5b45e930a3d4b4906/google-api-python-client-2.76.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.76.0
cd %{_builddir}/google-api-python-client-2.76.0
pushd ..
cp -a google-api-python-client-2.76.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675384599
