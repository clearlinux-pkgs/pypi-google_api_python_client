...
Source0  : https://files.pythonhosted.org/packages/29/9f/535346bb1469ec91139c38f0438ad70bd229a6b11452367065fe49303860/google_api_python_client-2.163.0.tar.gz
...
%prep
%setup -q -n google_api_python_client-2.163.0
cd %{_builddir}/google_api_python_client-2.163.0
pushd ..
cp -a google_api_python_client-2.163.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741227647
