...
Source0  : https://files.pythonhosted.org/packages/50/ca/9851ca334e9321be373081d508203c83cd4e5578fd3c7cf64036a0bd7648/google-api-python-client-2.74.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.74.0
cd %{_builddir}/google-api-python-client-2.74.0
pushd ..
cp -a google-api-python-client-2.74.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674662213
