...
Source0  : https://files.pythonhosted.org/packages/8a/ba/a1749dc0a194bf9280fb64cc90df46ac01addc1202d8be3e8478203bdde7/google-api-python-client-2.60.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.60.0
cd %{_builddir}/google-api-python-client-2.60.0
pushd ..
cp -a google-api-python-client-2.60.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662568119
