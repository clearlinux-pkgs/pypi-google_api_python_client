...
Source0  : https://files.pythonhosted.org/packages/36/40/487e2adabb8f9b96536f9909cec7937f27a2981e4c327d44d6633fdd286a/google-api-python-client-2.78.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.78.0
cd %{_builddir}/google-api-python-client-2.78.0
pushd ..
cp -a google-api-python-client-2.78.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676418210
