...
Source0  : https://files.pythonhosted.org/packages/df/d6/58ec56e2a2717ee16761b4809c3763d564b7478f49bf97f6d080e1a7553e/google-api-python-client-2.96.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.96.0
cd %{_builddir}/google-api-python-client-2.96.0
pushd ..
cp -a google-api-python-client-2.96.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1691520697
