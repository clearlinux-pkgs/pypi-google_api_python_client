...
Source0  : https://files.pythonhosted.org/packages/af/42/cbf81242376c99d6e5248e62aa4376bfde5bbefbe0a69b1b06fd4b73ab25/google_api_python_client-2.160.0.tar.gz
...
%prep
%setup -q -n google_api_python_client-2.160.0
cd %{_builddir}/google_api_python_client-2.160.0
pushd ..
cp -a google_api_python_client-2.160.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738079651
