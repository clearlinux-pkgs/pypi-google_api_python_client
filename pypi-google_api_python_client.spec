...
Source0  : https://files.pythonhosted.org/packages/84/7f/cc87798090179a13c1c0c65521e9d9477f16b64a2510c128d63604543be0/google-api-python-client-2.116.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.116.0
cd %{_builddir}/google-api-python-client-2.116.0
pushd ..
cp -a google-api-python-client-2.116.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706719046
