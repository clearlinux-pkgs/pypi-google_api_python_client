...
Source0  : https://files.pythonhosted.org/packages/d8/87/ce362b2878602d3b129db4896e4c37c0546606ac4bbffca0cec90805ccb7/google-api-python-client-2.136.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.136.0
cd %{_builddir}/google-api-python-client-2.136.0
pushd ..
cp -a google-api-python-client-2.136.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720054710
