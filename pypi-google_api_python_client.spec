...
Source0  : https://files.pythonhosted.org/packages/75/15/7e5d6cd003b0b08c7f17d30cfd8e7122976a6f1342b82913f7f2729c5bf8/google-api-python-client-2.80.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.80.0
cd %{_builddir}/google-api-python-client-2.80.0
pushd ..
cp -a google-api-python-client-2.80.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677686945
