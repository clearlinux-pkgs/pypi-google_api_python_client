...
Source0  : https://files.pythonhosted.org/packages/47/5f/2cb762b9996a4c3644a1efe602043ca178f3b63cce051bb83b729a04bead/google-api-python-client-2.114.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.114.0
cd %{_builddir}/google-api-python-client-2.114.0
pushd ..
cp -a google-api-python-client-2.114.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705420439
