...
Source0  : https://files.pythonhosted.org/packages/33/f5/01b3c47e568e180f2bf6a600c105ccd19cffc4f6938e9a6d8e5f707545fb/google-api-python-client-2.121.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.121.0
cd %{_builddir}/google-api-python-client-2.121.0
pushd ..
cp -a google-api-python-client-2.121.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709739594
