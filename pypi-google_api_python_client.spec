...
Source0  : https://files.pythonhosted.org/packages/d2/e8/8cbc3186a98b38332db85b4537cce71f0df170a35e5cd88c1dd3be4a0aca/google-api-python-client-2.95.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.95.0
cd %{_builddir}/google-api-python-client-2.95.0
pushd ..
cp -a google-api-python-client-2.95.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1690386982
