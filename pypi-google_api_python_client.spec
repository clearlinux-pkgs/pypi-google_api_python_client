...
Source0  : https://files.pythonhosted.org/packages/98/ac/3c1a4b068515b214757931d573b659525b213fb7ca7ef05d47a841c032e9/google-api-python-client-2.55.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.55.0
cd %{_builddir}/google-api-python-client-2.55.0
pushd ..
cp -a google-api-python-client-2.55.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659020681
