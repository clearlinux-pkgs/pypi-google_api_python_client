...
%prep
%setup -q -n google-api-python-client-2.71.0
cd %{_builddir}/google-api-python-client-2.71.0
pushd ..
cp -a google-api-python-client-2.71.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672932243
