...
Source0  : https://files.pythonhosted.org/packages/35/99/237cd2510aecca9fabb54007e58553274cc43cb3c18512ee1ea574d11b87/google_api_python_client-2.171.0.tar.gz
...
%prep
%setup -q -n google_api_python_client-2.171.0
cd %{_builddir}/google_api_python_client-2.171.0
pushd ..
cp -a google_api_python_client-2.171.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749046049
