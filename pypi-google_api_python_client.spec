...
Source0  : https://files.pythonhosted.org/packages/4a/af/6e9ba1d552043c69bddeb761126fe9c9c0a8e896d35a304785d132571523/google-api-python-client-2.73.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.73.0
cd %{_builddir}/google-api-python-client-2.73.0
pushd ..
cp -a google-api-python-client-2.73.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673994076
