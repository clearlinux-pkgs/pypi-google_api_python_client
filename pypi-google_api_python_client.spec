...
Source0  : https://files.pythonhosted.org/packages/6c/80/c031516e4651b8648c846e8642f2232c572368002738660f620247e84879/google-api-python-client-2.54.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.54.0
cd %{_builddir}/google-api-python-client-2.54.0
pushd ..
cp -a google-api-python-client-2.54.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658241264
...
cp %{_builddir}/google-api-python-client-2.54.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-google_api_python_client/7df059597099bb7dcf25d2a9aedfaf4465f72d8d
