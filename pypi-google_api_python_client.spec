...
Source0  : https://files.pythonhosted.org/packages/c8/45/cf03da7b4d74cba1425e35194379511af54c47a01f07bc41cc2084aabe43/google-api-python-client-2.56.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.56.0
cd %{_builddir}/google-api-python-client-2.56.0
pushd ..
cp -a google-api-python-client-2.56.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660058893
