...
Source0  : https://files.pythonhosted.org/packages/78/b6/ce62a006e9df3ba9ef4e1dfec0bee97f426ed0cdd05f1220740c267588b0/google_api_python_client-2.137.0.tar.gz
...
%prep
%setup -q -n google_api_python_client-2.137.0
cd %{_builddir}/google_api_python_client-2.137.0
pushd ..
cp -a google_api_python_client-2.137.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720642548
