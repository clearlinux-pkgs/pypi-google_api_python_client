...
Source0  : https://files.pythonhosted.org/packages/19/c9/ce294e72438f987b36151c49f91c1853d0fc37d59d7c360e926dae4f8a17/google-api-python-client-2.104.0.tar.gz
...
%prep
%setup -q -n google-api-python-client-2.104.0
cd %{_builddir}/google-api-python-client-2.104.0
pushd ..
cp -a google-api-python-client-2.104.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697639808
